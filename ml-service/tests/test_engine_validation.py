...
def test_irrelevant_extra_skill_does_not_reorder_unrelated_careers(tmp_path):
    ...
    r1 = {r['career']: r['confidence'] for r in predictor.predict_career_hybrid(base, {}, top_k=DATASET_CAREER_COUNT)}
    r2 = {r['career']: r['confidence'] for r in predictor.predict_career_hybrid(with_extra, {}, top_k=DATASET_CAREER_COUNT)}
